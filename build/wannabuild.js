...
},{"./components/Application.react":158,"react":156,"react-dom":1}],158:[function(require,module,exports){
'use strict';
...
var Application = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(WannaItem, null)
    );
  }
});
...
},{"./WannaItem.react":160,"react":156}],159:[function(require,module,exports){
"use strict";
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          { className: "mdl-textfield__label", classFor: "item-textfield" },
          "Fill what do you wanna build..."
        )
      )
    );
  }
...
var WannaItem = React.createClass({
  ...
  _onAddItem: function _onAddItem(e) {
  ...
  _getItemDone: function _getItemDone(index) {
  ...
  _getItemUninterested: function _getItemUninterested(index) {
    var item = this.state.items[index];
    item.status = 9;
    this.setState({
      item: item
  ...
  render: function render() {
    return React.createElement(
      'div',
      { className: 'WannaItem' },
      React.createElement(Inputbox, { posted_data: this.state.posted_data,
        _onChange: this._onChange,
        _onAddItem: this._onAddItem }),
      React.createElement(WannaList, { wannaItems: this.state.items,
...
},{"./Inputbox.react":159,"./WannaList.react":161,"react":156}],161:[function(require,module,exports){
"use strict";

var React = require('react');

var WannaList = React.createClass({
  displayName: "WannaList",

  getItemDone: function getItemDone(i) {
    this.props._getItemDone(i);
  },

  getItemUninterested: function getItemUninterested(i) {
          ...
          this.props.wannaItems.map(function (e, i) {
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "i",
                  { className: "material-icons", onClick: this.getItemDone.bind(this, i) },
                  "done"
                )
              ),
              React.createElement(
                ...
                React.createElement(
                  "i",
                  { className: "material-icons", onClick: this.getItemUninterested.bind(this, i) },
                  "thumb_down"
                )
              )
            );
